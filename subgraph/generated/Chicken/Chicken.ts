...
export class Chicken__allChickenRunResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: BigInt;
...
export class Chicken extends ethereum.SmartContract {
  static bind(address: Address): Chicken {
    return new Chicken("Chicken", address);
  }
  ...
  allChickenRun(param0: BigInt): Chicken__allChickenRunResult {
    let result = super.call(
      "allChickenRun",
    ...
    return new Chicken__allChickenRunResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_allChickenRun(
    param0: BigInt
  ): ethereum.CallResult<Chicken__allChickenRunResult> {
    let result = super.tryCall(
      "allChickenRun",
      "allChickenRun(uint256):(uint256,address,address,uint256,uint256,uint256,bool,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Chicken__allChickenRunResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toBigInt(),
  ...
  cns(param0: BigInt): string {
    let result = super.call("cns", "cns(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
  ...
  try_cns(param0: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall("cns", "cns(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
